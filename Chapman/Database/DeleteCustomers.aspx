<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeleteCustomers.aspx.cs" Inherits="Chapman.Database.DeleteCustomers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br /><br />
        ...
        ConnectionString="<%$ ConnectionStrings:ChapmanSQL %>"
        SelectCommand="DELETE FROM customers WHERE rummageID=@rummageID"
        >
            <SelectParameters>
